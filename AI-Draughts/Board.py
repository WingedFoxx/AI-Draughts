...
class Board:
    ...
    # Create a new black piece at position (y, x) and add it to the blacks list
    ...
    # Return a state of board after a move. Notice that we don't change the state of this board, but return a new board which shows how it will look like after making a move
